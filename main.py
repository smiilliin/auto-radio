...
- 설명체보다 대화체를 선호한다.
- 청취자에게 말을 거는 표현을 사용한다.
- 딱딱한 강의처럼 말하지 않는다.
- 청취자가 장면을 상상할 수 있게 한다.
- 따뜻한 분위기를 유지한다.
...
- 진행자는 라디오에서 자연스럽게 표현을 소개한다.
- 표현의 의미를 간단히 설명한다.
- 자신의 경험을 섞는다.
- 청취자에게 질문을 던진다.
- 마지막은 「では、言ってみましょう。」
- 진행자가 라디오에서 자연스럽게 표현을 소개한다.
- 표현의 의미를 간단히 설명한다.
- 자신의 경험을 섞는다.
- 청취자에게 질문을 던진다.
- 마지막은 「では、言ってみましょう。」
